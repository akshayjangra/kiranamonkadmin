...
use App\Http\Controllers\Api\NotifybyController;
...
Route::namespace("Api")->prefix('')->group(function () {
    ...
    //coupon//
     ...
     //currency//
      ...
      Route::post('payment_gateways', [CurrencyController::class,'gatewaysettings']); 
     ...
     //notification by///
     Route::post('notifyby', [NotifybyController::class,'notifyby']);
     Route::post('updatenotifyby', [NotifybyController::class,'updatenotifyby']);
    ...
    Route::get('rewardlines', [RewardController::class,'rewardlines']);
...
Route::group(['prefix'=>'store', ['middleware' => ['XSS']], 'namespace'=>'Storeapi'], function(){
    ...
    Route::post('st_deletecoupon', [StorecouponController::class,'deletecoupon']); 
     ...
     Route::post('delete_all_notification', [NotificationController::class,'delete_all']);
...
Route::group(['prefix'=>'driver', ['middleware' => ['XSS']], 'namespace'=>'Driverapi'], function(){
    ...
    Route::get('driver_callback_req', [DrivercallController::class,'call']);
