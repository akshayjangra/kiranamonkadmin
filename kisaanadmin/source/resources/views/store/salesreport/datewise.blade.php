...
<div class="col-lg-12">
<div class="col-lg-12"><a href="{{route('store_sales_today')}}" rel="tooltip">
                            <i class="material-icons" style="color:red">keyboard_backspace</i>{{ __('keywords.Back to Today Orders')}}
                            </a></div>    
<div class="card">    
